		...
		Cases: []Case{
			{
				...
				Want: Want{
					...
					Stderr: TextAssert{Equals: &emptyStderr, Contains: nil, Matches: nil},
				},
			},
			{
				...
				Want: Want{
					ExitCode: 7,
					Stdout:   TextAssert{Equals: nil, Contains: nil, Matches: nil},
					Stderr:   TextAssert{Equals: nil, Contains: []string{"warning"}, Matches: nil},
				},
			},
		},
	}
